...
- 以**現代台灣桌面慣例**為準（GNOME／KDE／Windows zh-TW 與 Arch Wiki zh-TW 的常見譯法）。
- 以 **IICM 電腦名詞譯名表**（中華民國資訊學會，78,396 筆）查照：
  - IICM 台灣用語與現代慣例一致或可接受時採用。
...
| system tray | 系統匣 | （tray 作「托盤」） | 依 MS／GNOME |
